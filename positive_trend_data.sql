-- Add positive trend data for Coca Cola (Stock Growing case)
-- This will create a scenario where stock-in is consistently higher than stock-out

-- Insert additional stock movements for Coca Cola showing positive growth
...
-- Add stable trend data for Sprite (Balanced case)
-- This will create a scenario where stock-in equals stock-out (stable trend)
...
-- Coca Cola: Strong positive trend (Stock Growing) - consistently higher stock-in than stock-out
-- Sprite: Stable trend (Stock Stable) - balanced stock-in and stock-out
